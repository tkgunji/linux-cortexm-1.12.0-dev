...
#define TI_VFPSTATE_CLEAN 576 /* offsetof(struct thread_info, vfpstate.hard.clean)	@ */

#define S_R0 40 /* offsetof(struct pt_regs, ARM_r0)	@ */
#define S_R1 44 /* offsetof(struct pt_regs, ARM_r1)	@ */
#define S_R2 48 /* offsetof(struct pt_regs, ARM_r2)	@ */
#define S_R3 52 /* offsetof(struct pt_regs, ARM_r3)	@ */
#define S_R4 0 /* offsetof(struct pt_regs, ARM_r4)	@ */
#define S_R5 4 /* offsetof(struct pt_regs, ARM_r5)	@ */
#define S_R6 8 /* offsetof(struct pt_regs, ARM_r6)	@ */
#define S_R7 12 /* offsetof(struct pt_regs, ARM_r7)	@ */
#define S_R8 16 /* offsetof(struct pt_regs, ARM_r8)	@ */
#define S_R9 20 /* offsetof(struct pt_regs, ARM_r9)	@ */
#define S_R10 24 /* offsetof(struct pt_regs, ARM_r10)	@ */
#define S_FP 28 /* offsetof(struct pt_regs, ARM_fp)	@ */
#define S_IP 56 /* offsetof(struct pt_regs, ARM_ip)	@ */
#define S_SP 32 /* offsetof(struct pt_regs, ARM_sp)	@ */
#define S_LR 60 /* offsetof(struct pt_regs, ARM_lr)	@ */
#define S_PC 64 /* offsetof(struct pt_regs, ARM_pc)	@ */
#define S_PSR 68 /* offsetof(struct pt_regs, ARM_cpsr)	@ */
#define S_OLD_R0 72 /* offsetof(struct pt_regs, ARM_ORIG_r0)	@ */
#define S_EXC_LR 36 /* offsetof(struct pt_regs, ARM_EXC_lr)	@ */
#define S_FRAME_SIZE 80 /* sizeof(struct pt_regs)	@ */
